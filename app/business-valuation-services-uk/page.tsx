...
export async function generateMetadata() {
  let seo = {
    ...
    canonical_url:
      "https://www.platform01consulting.com/business-valuation-services-uk",
  };
  try {
    const { data } = await supabaseAdmin
      .from("static_pages")
      .select("seo")
      .eq("slug", "/business-valuation-services-uk")
      .single();
    if (data?.seo) {
...
const BusinessValuationData: ServiceHeroData = {
  subheading: "Trusted Business Valuation Services in UK",
...
const valuesData = {
  heading: "Tailored Scope for Optimal Value in Business Valuation",
  supportingText:
...
const servicesData = [
  {
    title: "Standard Business Valuation",
    description: (
      <span>
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Bespoke business valuation services covering standard, distressed, startup, brand, and portfolio valuations.",
            url: "https://www.platform01consulting.com/business-valuation-services-uk",
            provider: {
              "@type": "Organization",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Business Valuation Services",
                item: "https://www.platform01consulting.com/business-valuation-services-uk",
              },
            ],
          }),
        }}
      ...
      {/* <div className="container pt-5 pb-20">
        <Header
          text="Comprehensive Business Valuation in UK"
          className="mb-26"
        />
        ...
        />
        <ChecklistItem
          text="Licensed Management Consulting firm in UK"
          className="py-6 border-b border-dark/10"
        />
        <ChecklistItem
      ...
      <TeamShowcase
        ...
        title="Our Business Valuation Team"
      ...
      <ServicesSection
        ...
        bgSurface={false}
        heading="Our Business Valuation Services"
