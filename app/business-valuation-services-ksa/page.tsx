...
const BusinessValuationData: ServiceHeroData = {
  subheading: "Trusted Business Valuation Services in KSA",
...
const teamData = {
  heading: "Accredited and <br/> Qualified Business Valuation Team in KSA",
  supportingText:
...
const valuesData = {
  heading: "Optimal Value in Business Valuation KSA",
  supportingText:
...
const servicesData = [
  {
    title: "Standard Business Valuation in KSA",
    description: (
      <span>
...
const BusinessValuationKSA = async () => {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Business Valuation Services KSA",
            description:
              "Professional business valuation services in KSA covering standard, distressed, startup, brand, and portfolio valuations.",
            url: "https://www.platform01consulting.com/business-valuation-services-ksa",
            provider: {
              "@type": "Organization",
              name: "Platform01 Consulting",
              award: [
                "Top M&A Boutique UAE 2025",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Business Valuation Services KSA",
                item: "https://www.platform01consulting.com/business-valuation-services-ksa",
              },
            ],
          }),
        }}
      ...
      <div className="container pt-5 pb-20">
        <Header
          text="Comprehensive Business Valuation in KSA"
          className="mb-26"
        />
        ...
        />
        <ChecklistItem
          text="Licensed Management Consulting firm in the KSA with offices in KSA and UAE"
          className="py-6 border-b border-dark/10"
        />
        <ChecklistItem
      ...
      <TeamText>
        <div>
          <h2 className="heading-3 max-w-[810px]">
            Exploring Business Valuation Services in KSA with Precision and
            Expertise
          </h2>
      ...
      <TeamShowcase
        title="Our Business Valuation KSA Team"
      ...
      <ServicesSection
        ...
        bgSurface={false}
        heading="Our Business Valuation Services KSA"
...
export default BusinessValuationKSA;
