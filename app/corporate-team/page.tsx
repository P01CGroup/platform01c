      ...
      <div className="container pt-5">
        ...
        <div className="mb-10">
          ...
          <p className="max-w-2xl text-dark/50">
            Our Corporate Team plays a critical role in delivering a seamless
            client experience by overseeing all matters related to Commercial
            and Corporate affairs. With a strong focus on process integrity and
            operational discipline, it empowers our Consulting Team to focus on
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mt-20">
          {ManagingDirector.map((member) => (
            <React.Fragment key={member.id}>
              <TeamCard member={member} className="md:col-start-2" />
        ...
        <h2 className="heading-3 mb-4 max-w-[1060px] pb-10">
          Our Commercial & Corporate team features industry Leaders with over 30
