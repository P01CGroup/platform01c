...
export async function generateMetadata() {
  let seo = {
    ...
    twitter_image: "",
    canonical_url:
      "https://www.platform01consulting.com/financial-modelling-and-analysis-uk",
  };
  try {
    const { data } = await supabaseAdmin
      .from("static_pages")
      .select("seo")
      .eq("slug", "/financial-modelling-and-analysis-uk")
      .single();
    if (data?.seo) {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            url: "https://www.platform01consulting.com/financial-modelling-and-analysis-uk",
            provider: {
              "@type": "Organization",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Financial Modelling Services",
                item: "https://www.platform01consulting.com/financial-modelling-and-analysis-uk",
              },
            ],
          }),
        }}
