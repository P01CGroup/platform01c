      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Transaction Advisory Services UAE",
            description:
              "End-to-end transaction advisory including M&A support, financial modelling, investor documentation, and deal execution.",
            url: "https://www.platform01consulting.com/transactions-advisory-services-uae",
            provider: {
              "@type": "Organization",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Transaction Advisory Services UAE",
                item: "https://www.platform01consulting.com/transactions-advisory-services-uae",
              },
            ],
          }),
        }}
