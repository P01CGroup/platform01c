      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Business Plan Development Services UAE",
            description:
              "No templates. No shortcuts. Platform01 builds bespoke business plans trusted by founders, boards and investors across UAE.",
            url: "https://www.platform01consulting.com/best-business-plan-consultants-uae",
            provider: {
              "@type": "Organization",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 2,
                name: "Business Plan Consultants UAE",
                item: "https://www.platform01consulting.com/best-business-plan-consultants-uae",
              },
            ],
          }),
        }}
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A business plan is a structured document that outlines your business vision, strategy, market opportunity, and financials. It's essential for raising funds, aligning stakeholders, and planning operations.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Unlike off-the-shelf templates, we create custom, investor-grade business plans grounded in regional context, strategic logic, and financial depth.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Typically, 3 to 5 weeks depending on the complexity and responsiveness. Fast-track timelines are available upon request.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Our plans include detailed 3 to 5 year forecasts covering profit and loss, cash flow, balance sheet, sensitivity analysis, KPI dashboards, and cap table where applicable.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. We guide you through key assumptions, conduct necessary market research, and build the plan collaboratively from a conceptual stage if needed.",
                },
              },
              {
                "@type": "Question",
                name: "Is the business plan suitable for investors in the UAE?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Absolutely. We tailor language, data points, and format to meet investor preferences in the UAE, aligning with VC, family office, and bank expectations.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. We often bundle the business plan, financial model, and pitch deck into a single engagement for a complete investor package.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. All client data is treated with strict confidentiality, with NDAs signed prior to project commencement upon request.",
                },
              },
            ],
          }),
