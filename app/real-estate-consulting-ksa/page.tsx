...
export async function generateMetadata() {
  let seo = {
    ...
    description:
      "Expert real estate consulting in Saudi Arabia, feasibility studies, HBU studies & investment advisory for developers & investors in KSA.",
    keywords: "",
    og_title: "",
    og_description: "",
    og_image: "",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Real estate advisory services in Saudi Arabia including feasibility studies, highest and best use studies, and investment advisory for developers and investors.",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              {
                "@type": "Question",
                name: "Do you offer feasibility studies for industrial projects (manufacturing, logistics)?",
                acceptedAnswer: {
                  "@type": "Answer",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "A standard feasibility study can take between 6 to 8 weeks depending on project complexity, site access, and input availability.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes, we can review, validate, or enhance an existing feasibility study with updated market data, sharper commercial logic, and improved financial modeling.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes, a financial feasibility study includes a financial model in Excel covering income statement, balance sheet, and cash flow projections based on project and market fundamentals.",
                },
              },
              {
                "@type": "Question",
      ...
      <section className="bg-surface">
        <div className="container pt-5 pb-20">
          ...
          <h2 className="heading-4 max-w-[1010px]">
            ...
            consulting services tailored to today's dynamic markets in the UAE
            and Saudi Arabia. Whether you are assessing a new development,
            repositioning an existing asset, or seeking transaction advisory
            opportunities in the sector, our practitioner-led team helps you
            make condent, data-driven decisions.
          </h2>
          {/* <h2 className="heading-4 max-w-[1010px]">
