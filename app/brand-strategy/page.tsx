...
export async function generateMetadata() {
  let seo = {
    ...
    twitter_description: "",
    twitter_image: "",
    canonical_url: "https://www.platform01consulting.com/brand-strategy",
  };
  try {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: "Brand Strategy & Marketing Consulting",
            description:
              "Full-scale brand marketing consulting services for B2B and B2C companies, covering brand identity, positioning, communication design, and reputation management.",
            url: "https://www.platform01consulting.com/brand-strategy",
            provider: {
              "@type": "Organization",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Brand Strategy",
                item: "https://www.platform01consulting.com/brand-strategy",
              },
            ],
          }),
        }}
