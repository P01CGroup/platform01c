...
const steps = [
  {
    number: "01.",
    title: "Preparation",
    items: ["Business Valuation", "Business Plan", "Marketing Materials"],
  },
  {
    number: "02.",
    title: "Buyer Origination",
    items: ["Buyer Fit Assessment", "Communication", "Letter of Intent"],
  },
  {
    number: "03.",
    title: "Deal Support",
    items: ["Negotiations", "Term Sheet", "Due Diligence"],
  },
  {
    number: "04.",
    title: "Deal Closing",
    items: ["Shareholder Agreement", "Post Deal Activities"],
  },
];
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5  items-end">
          ...
          <div className="flex flex-col gap-8 md:col-span-4 ">
            <Header text="Our Process" className="mb-26" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-5"> */}
          <p className="text-md text-dark/50 md:col-span-3 pt-4">
            {supportingText}
          </p>
        </div>
            ...
            <div key={idx} className="p-8 bg-[#F6F8FA] flex flex-col gap-16">
              ...
              <ul className="mt-4 space-y-2">
                {step.items.map((item, i) => (
                  <li
                    key={i}
                    className="text-dark/50 text-base flex items-start"
                  >
