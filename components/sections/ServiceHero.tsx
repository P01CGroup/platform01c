          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-10 md:pb-24 items-end w-full">
            <div className={`md:col-span-2 ${className}`}>
              ...
              {awards && awards.length > 0 && (
                <div className="mt-12">
                  <div className="flex items-end flex-wrap gap-10 w-full">
                    {awards.map((award, index) => (
                      <div
                        key={index}
                        className="flex flex-col w-full md:w-fit items-center gap-5"
                      >
                        <Image
                          src={award.image}
                          ...
                          width={80}
                        />
                        <span className="text-white text-center text-sm max-w-[250px]">
                          {parse(award.text)}
                        </span>
                      </div>
                    ))}
