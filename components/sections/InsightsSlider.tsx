...
// import InsightsSliderClient, { Insight } from "./InsightsSliderClient";
// import { getDatePart, areDatesDifferent } from "@/lib/utils/date-format";

// // Re-export the type so any page importing from InsightsSlider still works
// export type { Insight };

// // Re-export default for pages using: import InsightsSlider from "./InsightsSlider"
// export { default } from "./InsightsSliderClient";

// export async function DynamicInsightsSlider({
//   bgSurface = false,
//   heading = "Insights and Thought Leadership",
//   limit = 6,
// }: {
...
//       const publishedDate =
//         getDatePart(i.published_date) || getDatePart(new Date()) || "";
//       const updatedDate = getDatePart(i.updated_at);
//       return {
//         image:
//           i.image_url ||
//           "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=600&q=80",
...
//         excerpt: i.excerpt,
//         author: i.author,
//         coAuthor: i.co_author || "",
//         slug: i.slug,
//       };
//     });
//   } catch (e) {
//     // Supabase failed — render nothing, don't crash the page
//     return null;
//   }
...
//         <div className="container">
//           <h2 className="heading-3 max-w-[470px]">{heading}</h2>
//           <hr className="border-dark/10 mt-14" />
//           <div className="flex justify-center items-center py-16">
