...
const TeamShowcase = ({
  ...
  title = "Our Team",
  heading = "Our Team",
  supportingText = "Team Supporting Text",
  bgSurface = false,
  FourColumn = false,
  noHeader = false,
  ...
  return (
    ...
    >
      <div className={`container ${noHeader ? "pt-26" : ""}`}>
        {!noHeader && <Header className="mb-6" text={title} />}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-3 gap-5 gap-y-10 ${FourColumn ? "md:col-span-4 md:grid-cols-4" : "md:col-start-2 md:col-span-3  "}`}
          >
            {children}
          </div>
        </div>
